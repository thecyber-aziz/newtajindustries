    ...
    <footer className="bg-black text-gray-300 py-10 mt-20">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="mailto:info@tajindustries.com" className="hover:text-white transition">
                masoom8700@gmail.com.com
              </a>
            </li>
            <li>
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-center text-xs text-gray-500">
        <p>
          © {new Date().getFullYear()} New Taj Industry. All rights reserved.
        </p>

    ...
    <div className="overflow-hidden rounded-t-[2vw]" id="project">
        ...
        <div class="cardOuterBox grid justify-between grid-cols-1 md:grid-cols-2"> 
          <div class="cardInnerbox p-8 ">
             ...
             <div class="card bg-center bg-no-repeat bg-cover bg-[url('/AboutImg2.png')] w-full h-[30vh] md:w-[40vw] md:h-[30vw] border-zinc-950 border-[1px] rounded-[10px] my-[4vw] md:my-[2vw]"></div>
             {/* <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">AUDIT</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">COPYWRITING</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">SALESDECK</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">SLIDESDESIGN</button> */}
          ...
          <div class="cardInnerbox p-8">
             ...
             <div class="card bg-center  bg-no-repeat bg-cover bg-[url('AboutImg.png')] w-full h-[30vh] md:w-[40vw] md:h-[30vw] border-zinc-950 border-[1px] rounded-[10px] my-[4vw]  md:my-[2vw]"></div>
             {/* <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">AUDIT</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">COPYWRITING</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">SALESDECK</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">SLIDESDESIGN</button> */}
          ...
          <div class="cardInnerbox p-8">
             ...
             <div class="card bg-center bg-no-repeat bg-cover bg-[url('AboutImg3.png')] w-full h-[30vh] md:w-[40vw] md:h-[30vw] border-zinc-950 border-[1px] rounded-[10px] my-[4vw] md:my-[2vw]"></div>
             {/* <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">AUDIT</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">COPYWRITING</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">SALESDECK</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">SLIDESDESIGN</button> */}
          ...
          <div class="cardInnerbox p-8">
             ...
             <div class="card bg-center bg-no-repeat bg-cover bg-[url('AboutImg4.png')] w-full h-[30vh] md:w-[40vw] md:h-[30vw] border-zinc-950 border-[1px] rounded-[10px] my-[4vw]  md:my-[2vw]"></div>
             {/* <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">AUDIT</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">COPYWRITING</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">SALESDECK</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">SLIDESDESIGN</button> */}
